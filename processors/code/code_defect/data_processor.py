...
from processors.code.code_defect.data_collator import DataCollatorForDefectClassification
...
"""
The data processor for the code defect processor.
"""
class CodeDefectProcessor(CLSProcessor):
    def __init__(self,
                 data_args,
                 training_args,
                 model_args,
    ...
    def get_data_collator(self):
        ...
        return DataCollatorForDefectClassification(
            self.tokenizer,
