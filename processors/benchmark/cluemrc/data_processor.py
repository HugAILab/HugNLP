...
class CLUEMRCProcessor(CLSProcessor):
    def __init__(self, data_args, training_args, model_args, post_tokenizer=False, keep_raw_data=True):
        ...
        self.train_file = os.path.join(data_args.data_dir, 'mrc_style', 'train.json')
        if not os.path.exists(self.train_file):
            self.train_file = os.path.join(data_args.data_dir, 'all_train.json')
        self.dev_file = os.path.join(data_args.data_dir, 'mrc_style', 'dev.json')
        self.test_file = os.path.join(data_args.data_dir, 'mrc_style', 'test.json')
