...
class CosineSimilarityLoss(nn.Module):
    ...
    def forward(self, rep_a, rep_b, label: Tensor):
        ...
        output = self.cos_score_transformation(
            torch.cosine_similarity(rep_a, rep_b))
...
if __name__ == '__main__':
    ...
    examples1 = [
        'Beijing is one of the biggest city in China.',
        'Disney film is well seeing for us.'
    ]
    examples2 = [
        'Shanghai is the largest city in east of China.',
        'ACL 2021 will be held in line due to COVID-19.'
    ]
    label = [1, 0]
