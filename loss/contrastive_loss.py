...
if __name__ == '__main__':
    ...
    examples1 = [
        'This is the sentence anchor 1.',
        'It is the second sentence in this article named Section D.'
    ]
    examples2 = [
        'It is the same as anchor 1.',
        'I think it is different with Section D.'
    ]
    label = [1, 0]
    ...
    rep_candidate = model(
        **features2)[0]  # [batch_size, max_seq_len, hidden_dim]
